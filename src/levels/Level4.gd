...
func _ready():
	...
	game.grid.add_actor(Lib.new_actor(Vector2(4, 7), "", "mon1|lurdlud|3"))
	game.grid.add_actor(Lib.new_actor(Vector2(4, 2), "", "mon1|lrrdul|3"))
	game.grid.add_actor(Lib.new_actor(Vector2(1, 0), "", "mon1|dullrdd|3"))
	game.grid.add_actor(Lib.new_actor(Vector2(0, 1), "", "mon1|lrldur|3"))
	game.grid.add_actor(Lib.new_event(game.win, "cha1||Level5|...|Despicable creatures.|Following orders without thinking.|They cannot think for themselves.|...|I'm stronger.|I'm better.|..."))
	game.init()
